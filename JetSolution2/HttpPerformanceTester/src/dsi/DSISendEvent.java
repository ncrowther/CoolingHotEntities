...
public class DSISendEvent {
	...
	public static void main (String args[]) {
		...
		for (int i = 0; i < NUMBER_OF_EVENTS; i++) {
			...
			final String engineId = airplaneName + ":" + String.valueOf( (int)(Math.random() * NUMBER_OF_ENGINES));
			
			String engineEventXml = xmlFactory.createEngineEventXml(airplaneName, engineId);
